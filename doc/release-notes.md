...
### Bug Fixes
* An unintended sine wave tone no longer plays when the sim starts.

### Other Changes
* Now versioned together with Wave Interference.
* Improved ducking for the Wave Meter sound.
